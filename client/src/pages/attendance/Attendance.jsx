...
const Attendance = () => {
  ...
  const { user } = useAuth();
  const { records, summary, today, loading } = useSelector((s) => s.attendance);
            ...
            <div>
              {!today?.hasPunchedIn && (
                <button
                  ...
                  className="flex items-center gap-2 px-5 py-2.5 bg-green-600 hover:bg-green-700 text-white rounded-lg font-medium text-sm transition-colors"
                >
              ...
              {today?.hasPunchedIn && !today?.hasPunchedOut && (
                <button
                  ...
                  className="flex items-center gap-2 px-5 py-2.5 bg-red-600 hover:bg-red-700 text-white rounded-lg font-medium text-sm transition-colors"
                >
