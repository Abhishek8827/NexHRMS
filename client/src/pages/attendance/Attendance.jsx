        ...
        <div className="flex items-center justify-between px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-200 dark:border-gray-700">
          ...
          <div className="flex items-center gap-1 sm:gap-2">
            ...
            <button
              ...
              className="px-2 sm:px-3 py-1 sm:py-1.5 text-xs font-medium text-primary-600 hover:bg-primary-50 dark:hover:bg-primary-900/20 rounded-lg"
            >
              This Month
            </button>
            <button
              ...
              <table className="w-full">
                ...
                <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                  {records.map((r, i) => (
                    ...
                    >
                      <td className="px-4 lg:px-6 py-3 text-sm font-medium text-gray-700 dark:text-gray-300">
                        {formatDate(r.date)}
                      </td>
